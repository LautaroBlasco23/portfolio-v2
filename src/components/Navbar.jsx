  ...
  return (
    <div className="text-xl text-blue-200 fixed z-10 bg-blue-950 w-full p-2 flex items-center justify-around">
      ...
      <div className="flex justify-end">
        <span className="text-white mr-8 hover:cursor-pointer hover:text-black duration-300"><a href="https://drive.google.com/file/d/10JA8m5yGGzQPWOFieXqtgtX_p-MWfc4d/view?usp=sharing" target={"_blank"}>CV</a></span>
