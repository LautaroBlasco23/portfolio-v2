...
const ProjectCard = (repoData) => {
  return (
    <div className="shadow-2xl hover:border-white hover:border relative flex flex-col items-center mt-4 border border-black rounded-md p-4 bg-neutral-800 text-white h-[280px] w-[260px] hover:scale-110 ease-in duration-500">
      <h1 className="font-bold text-lg">{repoData.title}</h1>
