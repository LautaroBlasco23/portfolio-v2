...
const ProjectCard = (repoData) => {
  return (
    <div className="relative flex flex-col items-center mt-4 border border-black rounded-md p-4 bg-blue-950 text-white h-[280px] w-[260px] hover:scale-110 ease-in duration-500">
